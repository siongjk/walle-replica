...
//126
static const unsigned char solar_bits[] PROGMEM = {
  ...
  0x42, 0x08, 0x46, 0x0C, 0x38, 0x00,  
    ...
    u8g2.drawXBMP( 25, 33, sun_width, sun_height, sun_bits); //The sun image
    u8g2.drawXBMP( 1, 0, solar_width, solar_height, solar_bits); //wording in BMP
}
